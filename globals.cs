...
namespace our_first_menu
{
    ...
    {
        public static IntPtr engineAdress;
        public static IntPtr clientAdress;

        // trigger bot
        public static bool triggerBot = false;
        public static int triggerBotDelay = 20;

        // glow
        public static bool glow = false;

        // aimbot
        private static bool _fovCircle = false;
        public static bool fovCircle
        {
            get { return _fovCircle; }
            set { _fovCircle = value; Form2.Instance.RefreshPanel(); }
        }
        public static bool aimbot = false;
        private static float _aimbotFOV = 7f;
        public static float aimbotFOV
        {
            ...
            set
            {
                ...
                if(Form2.Instance != null)
                    Form2.Instance.RefreshPanel();
            }
        }
        public static float aimbotSmooth = 5f;
        public static int aimbotLocation = 8; // 8 = head
    }
